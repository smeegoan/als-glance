CREATE TABLE [dbo].[AspNetExtApiAuthenticationTokens] (
    ...
    CONSTRAINT [FK_dbo.AspNetExtApiAuthenticationTokens_dbo.AspNetExtApiApplications_ApiApplicationId] FOREIGN KEY ([ApiApplicationId]) REFERENCES [dbo].[AspNetExtApiApplications] ([Id]),
    CONSTRAINT [FK_dbo.AspNetExtApiAuthenticationTokens_dbo.AspNetExtApiUsers_BaseApiUserId] FOREIGN KEY ([BaseApiUserId]) REFERENCES [dbo].[AspNetExtApiUsers] ([Id])
);
